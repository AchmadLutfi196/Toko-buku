...
<head>
    ...
    <title>Admin BukuKu   - Dashboard</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">BukuKu.com</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                elseif (isset($_GET['tambah_banner'])) 
                {
                    include 'tambah/tambah_banner.php';
                }
                elseif (isset($_GET['edit_banner'])) 
                {
                    include 'edit/edit_banner.php';
                }
                elseif (isset($_GET['hapus_banner'])) 
                {
                ...
                elseif (isset($_GET['detail_pelanggan'])) 
                {
                    include 'detail/detail_pelanggan.php';
                }
                else{
                    include 'banner.php';
                }
    ...
    <script src="https://kit.fontawesome.com/dc93241879.js" crossorigin="anonymous"></script>
</body>
