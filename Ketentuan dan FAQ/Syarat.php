    ...
    <div class="accordion">
        <div class="accordion-item">
            ...
            <div class="accordion-content">
                <p>Asuransi pengiriman adalah layanan tambahan untuk melindungi barang kiriman dari resiko kerusakan maupun kehilangan selama perjalanan. Asuransi ini dapat digunakan untuk seluruh jenis produk di Bukuku.com. Namun ada beberapa produk yang diwajibkan menggunakan asuransi pengiriman.
                    <br><br>
                    Biaya asuransi ditanggung oleh pihak customer saat melakukan pemesanan produk. Nilai yang dibebankan kepada customer sebesar 0.3% (nol koma tida persen) dari subtotal biaya. Jika terjadi resiko yang ditanggung, maka customer akan mendapatkan ganti rugi sesuai perhitungan yang berlaku.
                    <br><br>
                    Pengaduan/klaim atas kerusakan atau kehilangan dapat diajukan selambat-lambatnya dalam waktu 3 (tiga) hari terhitung sejak pesanan diterima.</p>
            </div>
        </div>
        <div class="accordion-item">
            <div class="accordion-header">
                Apakah saya bisa mengembalikan barang yang saya terima apabila tidak sesuai atau rusak?
                <span class="icon">&#9656;</span>
            </div>
            <div class="accordion-content">
                <p>Periksa kelengkapan dan kondisi paketmu dalam 14 hari setelah paket diterima dengan video ketika dibuka. Tanpa menyertakan video unboxing, mohon maaf klaim tidak dapat diterima.</p>
            </div>
        </div>
        <div class="accordion-item">
            <div class="accordion-header">
            ...
            <div class="accordion-content">
                <p>Sayangnya, sekarang kamu belum bisa mengembalikan barang yang sudah dipesan dan sudah diantarkan. Untuk informasi lebih lanjut kamu dapat menghubungi Customer Support kami </p>
            </div>
        </div>
    </div>
